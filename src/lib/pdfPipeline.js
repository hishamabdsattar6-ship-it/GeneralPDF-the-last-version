 ...
 */
export async function triagePdf(filePath) {
    try {
 ...
 */
export async function processScannedPdfWithGemini(filePath, mimeType = 'application/pdf') {
    try {
 ...
 */
export async function extractTextPipeline(filePath) {
